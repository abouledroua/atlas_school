...
// class FicheNewEnseignant extends StatefulWidget {
//   const FicheNewEnseignant({Key? key}) : super(key: key);

//   @override
//   _FicheNewEnseignantState createState() => _FicheNewEnseignantState();
// }

// class _FicheNewEnseignantState extends State<FicheNewEnseignant> {
//   bool accept = false;
...
//                   centerTitle: true,
//                   title: const FittedBox(child: Text("Nouveau Enseignant")),
//                   leading: IconButton(
//                       onPressed: () {
...
//                     showCloseIcon: true,
//                     title: 'Erreur',
//                     desc: "Cet Enseignant existe déjà !!!");
//                 break;
//               default:
//             }
//           } else {
...
//             ]),
//           const SizedBox(height: 10),
//           if (txtMatiere.text.isNotEmpty)
//             Row(children: [
//               const Expanded(
//                   child: Text("Matière : ",
//                       style: TextStyle(fontWeight: FontWeight.bold))),
//               Expanded(flex: 2, child: Text(txtMatiere.text))
//             ])
//         ]);
